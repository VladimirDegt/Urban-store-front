...
export const HeaderCatalog: React.FC = () => {
    ...
    return (
        <div className={styles.header__catalog}>
            <ul>
                <li className={styles.catalog__title}><Link to="/all-items">View all</Link></li>
                <li><Link to="/sales" className={styles.catalog__sale}>Sale</Link></li>
                <li><Link to="/best-sellers" className={styles.catalog__bestsellers}>Best sellers</Link></li>
                ...
                <li><Link to="/">Manga | Books</Link></li>
